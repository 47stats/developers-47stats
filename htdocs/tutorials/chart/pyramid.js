function pyramidBuilder(data, target, options) {
    ...
    leftBarGroup.selectAll('.bar.left')
        ...
        .attr('height', (yScale.range()[0] / data.length) - margin.middle / 4)
        .on("mouseover", function (d) {
            tooltipDiv.transition()
                .duration(200)
                .style("opacity", 0.9);
            tooltipDiv.html(
                "<p class='text-xs text-gray-700 sm:pl-4 sm:py-2 sm:mt-0 mt-4'>" +
                    "<strong>Males Age " + d.age + "</strong>" +
    ...
    rightBarGroup.selectAll('.bar.right')
        ...
        .on("mouseover", function (d) {
            ...
            tooltipDiv.html(
                "<p class='text-xs text-gray-700 sm:pl-4 sm:py-2 sm:mt-0 mt-4'>" +
                    "<strong> Females Age " + d.age + "</strong>" +
